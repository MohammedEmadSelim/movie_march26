...
import '../../models/carousel_movie_model.dart';
  ...
  Future<void> getCarouselMovies()async{
    ...
    try{
      var res = await dio.get("https://api.themoviedb.org/3/discover/movie",
          options: Options(
              headers: {
                "Authorization": "Bearer yJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxYmYwNzRjYzk3MzE0YmRiMWZmM2VlMmQ3NWUwNWY0ZiIsIm5iZiI6MTc2MTM5NzAxOS4xMDgsInN1YiI6IjY4ZmNjOTFiYzQzZDA1OTllMjkzODUwNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.lzdT9GXoMtzophhJo7yb5wZ0MviXwdxUh7Lo1kVT1N4",
