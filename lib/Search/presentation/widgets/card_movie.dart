...
class Card_movie extends StatefulWidget {
  ...
  @override
  State<Card_movie> createState() => _Card_movieState();
}
        ...
        Row(
          ...
          children: [
            ClipRRect(
              ...
              child:
              Custom_image_network(data: widget.data, index: widget.data.indexOf(widget.movie), height: 120, width: 95)
              //  Image.network(
            ...
            Column(
              ...
              children: [
                ...
                custom_row_serach_page(
                  text: widget.movie.voteAverage.toString().substring(0,3),
                ...
                custom_row_serach_page(
                  text: '${widget.movie.voteCount+10} minutes',
      ...
      Positioned(
                        ...
                        child: GestureDetector(
                          ...
                          child: Icon(size: 20,
                            ...
                            color: moviesBox.containsKey(widget.movie.id)
                                ? Appcolor.red_color
